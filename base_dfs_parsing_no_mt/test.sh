#!/bin/bash
set -eux
nargo execute base_dfs_parsing_no_mt --package base_dfs_parsing_no_mt

BACKEND=../bbnew

$BACKEND write_vk -b ../target/base_dfs_parsing_no_mt.json -o ../target/vk   
mkdir -p proofs
start=$(python3 -c "import time; print(time.time_ns())")
$BACKEND prove -b ../target/base_dfs_parsing_no_mt.json -w ../target/base_dfs_parsing_no_mt.gz -o ./proofs/proof
